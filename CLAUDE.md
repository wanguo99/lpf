...
# 1. 加载预定义配置
python3 build.py config <config_name>    # 例如：ccm_h200p100_development_defconfig, tests_x86_full_defconfig
...
#### 产品配置
- `ccm_h200p100_development_defconfig` - CCM H200P100 开发环境（包含所有调试功能）
- `ccm_h200p100_production_defconfig` - CCM H200P100 生产环境（优化配置，禁用测试）
