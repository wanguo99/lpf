...
# 1. 加载预定义配置
python3 build.py config <config_name>    # 例如：ccm_h200p100_debug_defconfig, tests_x86_full_defconfig
...
#### 产品配置
- `ccm_h200p100_debug_defconfig` - CCM H200P100 调试版本（包含所有调试功能）
- `ccm_h200p100_release_defconfig` - CCM H200P100 发布版本（优化配置，禁用测试）
