...
./output/target/bin/unit-test -m test_hal_serial # 运行串口测试
./output/target/bin/unit-test -m test_hal_i2c    # 运行I2C测试
./output/target/bin/unit-test -m test_hal_spi    # 运行SPI测试
