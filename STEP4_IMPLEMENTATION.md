...
### Modified
1. `/home/wanguo/EMS/products/tests/include/test_core.h` - Added `auto_test_case_t` structure
2. `/home/wanguo/EMS/products/tests/include/test_framework.h` - Added 10+ simplified macros

### Created
1. `/home/wanguo/EMS/products/tests/examples/test_example_simplified.c` (⭐ Recommended)
2. `/home/wanguo/EMS/products/tests/examples/test_example_with_fixture.c`
3. `/home/wanguo/EMS/products/tests/examples/test_example_simple_auto.c`
4. `/home/wanguo/EMS/products/tests/examples/test_example_minimal.c`
5. `/home/wanguo/EMS/products/tests/examples/README.md`
...
- `/home/wanguo/EMS/products/tests/examples/README.md` - User guide with examples
- `/home/wanguo/EMS/products/tests/include/test_framework.h` - Inline API documentation
